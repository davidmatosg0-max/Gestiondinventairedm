...
export const mockComandas: Comanda[] = [
  {
    ...
    items: [
      { 
        ...
        nombreProducto: 'Céréales (Boîte 2kg)',
        cantidad: 15, 
      ...
      { 
        ...
        nombreProducto: 'Conserves Variées',
        cantidad: 30, 
      ...
      { 
        ...
        nombreProducto: 'Fruits Variés (PRS)',
        cantidad: 25, 
        cantidadEntregada: 25,
        unidad: 'kg'
      }
    ],
    usuarioCreacion: 'Marie Dubois',
    fechaEntrega: '2025-01-01',
    observaciones: 'Entregada y recibida par l\'organisme. Tous les produits en bon état.'
  },
  {
    id: '2',
    numero: 'CMD-002',
    ...
    items: [
      ...
      { 
        ...
        nombreProducto: 'Légumes Variés (PRS)',
        cantidad: 35,
        unidad: 'kg',
        completado: false
      },
      { 
        ...
        nombreProducto: 'Lait en poudre (Sac 25kg)',
        cantidad: 3,
        unidad: 'sacs',
        completado: true
      },
      ...
      { 
        ...
        nombreProducto: 'Pommes de terre',
        cantidad: 25,
        unidad: 'kg',
        completado: true
      },
    ...
    usuarioCreacion: 'Jean Tremblay',
    fechaEntrega: '2025-01-10',
    fechaLimiteRespuesta: '2025-01-05',
    observaciones: 'Grande commande pour la Fondation. Vérifier la température des produits réfrigérés.'
  },
  {
    id: '3',
    numero: 'CMD-003',
    ...
    items: [
      ...
      { 
        ...
        nombreProducto: 'Conserve de Tomate',
        cantidad: 20,
        unidad: 'boîtes'
      },
      { 
        productoId: 'prod-conserva-mais', 
        nombreProducto: 'Conserve de Maïs',
        cantidad: 25,
        unidad: 'boîtes'
      },
      { 
        productoId: 'prod-conserva-haricots', 
        nombreProducto: 'Conserve de Haricots',
        cantidad: 30,
        unidad: 'boîtes'
      },
      { 
    ...
    fechaLimiteRespuesta: '2025-01-04',
    observaciones: 'Foyer pour enfants - Priorité aux produits nutritifs et variés'
  },
  {
    id: '4',
    numero: 'CMD-004',
    ...
    observaciones: 'Completada et prête à être livrée. Centre communautaire - grande capacité.'
  },
  {
    id: '5',
    numero: 'CMD-005',
    ...
    fechaLimiteRespuesta: '2025-01-06',
    observaciones: 'Salle communautaire - Commande hebdomadaire régulière avec produits variés'
  }
];
...
export const mockOrganismos: Organismo[] = [
  {
    id: '1',
    nombre: 'Salle Communautaire Saint-Joseph',
    tipo: 'Salle à Manger',
    responsable: 'Anne Tremblay',
    telefono: '555-0101',
    email: 'salle.saintjoseph@email.com',
    direccion: '1250 Boulevard Curé-Labelle, Chomedey, Laval, QC H7W 1A1',
    codigoPostal: 'H7W 1A1',
    activo: true,
    fechaRegistro: '2023-05-15',
    beneficiarios: 150,
    claveAcceso: 'CSJ-8K9M2P',
  ...
  {
    id: '2',
    nombre: 'Fondation Espoir',
    tipo: 'Fondation',
    responsable: 'Robert Bélanger',
    telefono: '555-0102',
    email: 'fondation.espoir@email.com',
    direccion: '2340 Boulevard Cartier Ouest, Laval-des-Rapides, Laval, QC H7N 1A1',
    codigoPostal: 'H7N 1A1',
    activo: false,
    fechaRegistro: '2023-08-20',
    beneficiarios: 200,
    fechaInicioInactividad: '2025-12-15',
    fechaFinInactividad: '2026-02-28',
    claveAcceso: 'FES-3X7N5Q',
    participaPRS: true, // Participa en PRS
    tipoAsistencia: 'regular',
    frecuencia: 2 // 2 veces por semana
  },
  {
    id: '3',
    nombre: 'Foyer pour Enfants La Paix',
    tipo: 'Foyer',
    responsable: 'Laura Gagnon',
    telefono: '555-0103',
    email: 'foyer.lapaix@email.com',
    direccion: '875 Boulevard de la Concorde Est, Duvernay, Laval, QC H7A 1A1',
    codigoPostal: 'H7A 1A1',
    activo: true,
    fechaRegistro: '2023-11-10',
    beneficiarios: 80,
    claveAcceso: 'HLP-6T4R8W',
    participaPRS: false, // NO participa en PRS
    tipoAsistencia: 'ocasional',
    frecuencia: 1 // 1 vez par semaine
  },
  {
    id: '4',
    nombre: 'Centre Communautaire Le Chêne',
    tipo: 'Centre Communautaire',
    responsable: 'Michel Dubois',
    telefono: '555-0104',
    email: 'centre.lechene@email.com',
    direccion: '4500 Boulevard Sainte-Rose, Sainte-Rose, Laval, QC H7L 1A1',
    codigoPostal: 'H7L 1A1',
    activo: true,
    fechaRegistro: '2024-02-05',
    beneficiarios: 120,
    claveAcceso: 'CER-9Y2L5D',
    participaPRS: true, // Participa en PRS
    tipoAsistencia: 'regular',
