...
export function Dashboard() {
  ...
  const [tabActual, setTabActual] = useState<'dashboard' | 'contacts'>('dashboard');
  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
      ...
      {/* Tabs para Dashboard y Contactos */}
      <Tabs value={tabActual} onValueChange={(value) => setTabActual(value as 'dashboard' | 'contacts')} className="space-y-6">
