...
export function GestionDonateursFournisseurs() {
  ...
  useEffect(() => {
    ...
    // Si no hay datos, crear ejemplos de demostración
    if (data.length === 0) {
      const ejemplos: DonateurFournisseur[] = [
        {
          id: '1',
          isDonateur: true,
          isFournisseur: false,
          participantPRS: true,
          nomEntreprise: 'IGA Laval Centre',
          telephone: '(450) 687-5555',
          adresse: '1500 Boulevard Le Corbusier, Laval, QC H7S 2K1',
          personnesContact: [{
            id: '1',
            nom: 'Marie Tremblay',
            email: 'marie.tremblay@iga.com',
            telephone: '(450) 687-5556'
          }],
          actif: true,
        ...
        },
        {
          ...
          isFournisseur: false,
          participantPRS: true,
          nomEntreprise: 'Metro Plus Laval',
          telephone: '(450) 688-7777',
          adresse: '3025 Boulevard Le Carrefour, Laval, QC H7T 1C7',
          personnesContact: [{
            id: '2',
            nom: 'Jean-François Leblanc',
            email: 'jf.leblanc@metro.ca',
            telephone: '(450) 688-7778'
          }],
          actif: true,
          dateCreation: new Date().toISOString()
        },
        {
          ...
          isDonateur: false,
          isFournisseur: true,
          participantPRS: false,
          nomEntreprise: 'Aliments Duval Inc.',
          telephone: '(450) 662-3333',
          adresse: '2700 Autoroute des Laurentides, Laval, QC H7T 2X7',
          personnesContact: [{
            id: '3',
            nom: 'Pierre Duval',
            email: 'p.duval@alimentsduval.com',
            telephone: '(450) 662-3334'
          }],
          actif: true,
          dateCreation: new Date().toISOString()
        },
        {
          ...
          isFournisseur: true,
          participantPRS: true,
          nomEntreprise: 'Provigo Laval',
          telephone: '(450) 689-9999',
          adresse: '3100 Boulevard Le Carrefour, Laval, QC H7T 1C7',
          personnesContact: [{
            id: '4',
            nom: 'Sophie Gagnon',
            email: 'sophie.gagnon@provigo.ca',
            telephone: '(450) 689-9998'
          }],
          actif: true,
          dateCreation: new Date().toISOString()
        }
